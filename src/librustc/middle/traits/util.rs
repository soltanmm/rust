...
impl<'cx, 'tcx> Elaborator<'cx, 'tcx> {
    ...
    fn push(&mut self, predicate: &ty::Predicate<'tcx>) {
        ...
        // bounds when elaborating all predicates. This should become a non-issue in whatever
        // future logic-proof-based refactoring comes along for the type system. The reason why
        // this is hard, you could have a trait like this:
        //
        // trait A { type B: A; }
        //
        ...
        // code is trying to fulfill. We don't know (and it requires quite a bit of refactoring to
        // know) how deep to go down the rabbit hole from here.
